...
class ServiceEndpoint:
    ...
    host: str = os.environ.get("POLYGLOT_HOST", "localhost")
    http_port: int = int(os.environ.get("POLYGLOT_HTTP_PORT", 8080))
    grpc_port: int = int(os.environ.get("POLYGLOT_GRPC_PORT", 50051))
...
class GoClient:
    ...
    def __init__(
        ...
        self.inference_endpoint = inference_endpoint or ServiceEndpoint(
            host=os.environ.get("POLYGLOT_INFERENCE_HOST", "localhost"),
            http_port=int(os.environ.get("POLYGLOT_INFERENCE_HTTP_PORT", 8080)),
            grpc_port=int(os.environ.get("POLYGLOT_INFERENCE_GRPC_PORT", 50051))
        )
        self.cache_endpoint = cache_endpoint or ServiceEndpoint(
            host=os.environ.get("POLYGLOT_CACHE_HOST", "localhost"),
            http_port=int(os.environ.get("POLYGLOT_CACHE_HTTP_PORT", 8081)),
            grpc_port=int(os.environ.get("POLYGLOT_CACHE_GRPC_PORT", 50052))
        )
...
class GoCacheClient:
    ...
    def __init__(
        self,
        host: str = os.environ.get("POLYGLOT_CACHE_HOST", "localhost"),
        port: int = int(os.environ.get("POLYGLOT_CACHE_HTTP_PORT", 8081))
    ):
