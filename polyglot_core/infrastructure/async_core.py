...
Example:
    >>> import asyncio
    >>> from optimization_core.polyglot_core.infrastructure.async_core import (
...
class WebSocketStreamer:
    ...
    def __init__(self, host: str = os.environ.get("POLYGLOT_WS_HOST", "localhost"), port: int = int(os.environ.get("POLYGLOT_WS_PORT", 8765))):
        self.host = host
        self.port = port
        self._server = None
