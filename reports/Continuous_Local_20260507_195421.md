Se ha implementado la cuadragésimo quinta técnica SOTA de mitigación de alucinaciones: **Chain-of-Thought (CoT) Prompting** (arXiv:2201.11903, Wei et al., 2022). Este método elicita razonamiento paso a paso, reduciendo la generación de hechos falsos al estructurar el proceso de inferencia. El código está en `/workspace/truthgpt_cot.py`.

**Técnicas implementadas (45):**
...
45. Chain-of-Thought (arXiv:2201.11903) – `/workspace/truthgpt_cot.py`
