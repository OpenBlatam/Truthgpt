Se ha implementado la vigésimo cuarta técnica SOTA de mitigación de alucinaciones: **AlignScore** (arXiv:2305.16793). Este método entrena un modelo unificado para puntuar la consistencia factual entre texto generado y fuente, logrando alto rendimiento en benchmarks como TRUE y SummaC. Código en `/workspace/truthgpt_alignscore.py`.

**Técnicas implementadas (24):**
