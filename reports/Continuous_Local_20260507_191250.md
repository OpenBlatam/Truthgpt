Se ha implementado la vigésimo octava técnica SOTA de mitigación de alucinaciones: **Contrastive Decoding** (arXiv:2210.15097). Este método reduce las alucinaciones en modelos de lenguaje grandes contrastando las distribuciones de probabilidad del modelo experto con las de un modelo anti-experto más pequeño, favoreciendo tokens que el experto asigna alta probabilidad pero el anti-experto no. El código está en `/workspace/truthgpt_contrastive_decoding.py`.

**Técnicas implementadas (28):**
