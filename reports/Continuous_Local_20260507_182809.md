Se ha implementado la decimocuarta técnica SOTA de detección de alucinaciones: **CONFACTCHECK** (arXiv:2511.12236 – IJCNLP-AACL 2025). Este método detecta alucinaciones mediante la generación de preguntas de prueba factuales a partir del texto generado, consultando al mismo LLM (o a múltiples LLMs) y midiendo la consistencia de las respuestas, sin necesidad de bases de conocimiento externas. El código está en `/workspace/truthgpt_confactcheck.py`.

**Técnicas implementadas (14):**
