Se ha implementado la vigésimo primera técnica SOTA de mitigación de alucinaciones: **FactScore** (arXiv:2305.14251). Este método evalúa la consistencia factual de las generaciones descomponiendo el texto en afirmaciones atómicas y verificándolas contra una fuente de conocimiento, logrando una alta correlación con evaluaciones humanas. El código está en `/workspace/truthgpt_factscore.py`.

**Técnicas implementadas (21):**
