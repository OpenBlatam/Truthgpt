Se ha implementado la undécima técnica SOTA de detección de alucinaciones: **SimpleText Ensemble** (arXiv:2508.11823), basada en el enfoque del CLEF 2025 SimpleText Task 2 que integra BERT classifier, similitud semántica, NLI y razonamiento LLM mediante meta-clasificadores. El código está en `/workspace/truthgpt_simpletext_ensemble.py`.

**Técnicas implementadas (11):**
