Se ha implementado la duodécima técnica SOTA de detección de alucinaciones: **GraphEval** (arXiv:2407.10793 – KDD 2024 KiL Workshop). Este framework basado en grafos de conocimiento extrae tripletas sujeto-predicado-objeto de la respuesta del LLM, las verifica mediante NLI frente al contexto de referencia, y permite corrección automática vía GraphCorrect. El código está en `/workspace/truthgpt_grapheval.py`.

**Técnicas implementadas (12):**
