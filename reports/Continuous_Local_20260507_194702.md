Se ha implementado la cuadragésimo tercera técnica SOTA de mitigación de alucinaciones: **Semantic Entropy** (arXiv:2306.03271, Kuhn et al., 2023). Este método mide la incertidumbre mediante el agrupamiento semántico de secuencias generadas, indicando alucinaciones cuando la entropía semántica es alta. El código está en `/workspace/truthgpt_semantic_entropy.py`.
...
43. Semantic Entropy – `/workspace/truthgpt_semantic_entropy.py`
