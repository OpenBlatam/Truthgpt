Se ha implementado la decimosexta técnica SOTA de detección de alucinaciones: **mdok of KInIT** (arXiv:2506.01702v2) – robust fine-tuning de LLMs para detección binaria y multiclase de texto generado por IA, útil para identificar outputs alucinados en múltiples idiomas. El código está en `/workspace/truthgpt_mdok_kinit.py`.

**Técnicas implementadas (16):**
