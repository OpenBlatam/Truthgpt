Se ha implementado la trigésimo séptima técnica SOTA de mitigación de alucinaciones: **KTO (Kahneman-Tversky Optimization)** (arXiv:2401.03984, Ethayarajh et al., 2024). Este método utiliza la teoría de prospectos para alinear modelos sin necesidad de preferencias emparejadas, optimizando directamente las recompensas humanas. El código está en `/workspace/truthgpt_kto.py`.

**Técnicas implementadas (37):**
