Se ha implementado la trigésimo quinta técnica SOTA de mitigación de alucinaciones: **ORPO (Odds Ratio Preference Optimization)** (arXiv:2403.07691, Hong et al., 2024). Este método elimina la necesidad de un modelo de referencia y una fase separada de alineación, integrando la optimización de preferencias directamente durante el fine-tuning supervisado mediante un odds ratio entre estilos preferidos y no preferidos. Logra mejoras significativas en AlpacaEval, IFEval y MT-Bench con modelos de hasta 7B. El código está en `/workspace/truthgpt_orpo.py`.

**Técnicas implementadas (35):**
