Se ha implementado la trigésima técnica SOTA de mitigación de alucinaciones: **Inference-Time Intervention (ITI)** (arXiv:2306.03341). Este método identifica una dirección en el espacio de activaciones del LLM que separa afirmaciones verdaderas de falsas y, durante la inferencia, desplaza las activaciones a lo largo de esa dirección para promover la generación veraz. El código está en `/workspace/truthgpt_iti.py`.

**Técnicas implementadas (30):**
