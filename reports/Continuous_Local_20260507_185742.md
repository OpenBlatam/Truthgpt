Se ha implementado la vigésimo segunda técnica SOTA de mitigación de alucinaciones: **DOLA (Decoding by Contrasting Layers)** (arXiv:2309.03883). Esta técnica contrasta las predicciones de capas prematuras y maduras del LLM para reducir la generación de contenido falso, mejorando la veracidad sin necesidad de entrenamiento adicional. El código está en `/workspace/truthgpt_dola.py`.

**Técnicas implementadas (22):**
