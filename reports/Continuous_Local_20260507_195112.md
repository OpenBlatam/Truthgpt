Se ha implementado la cuadragésimo cuarta técnica SOTA de mitigación de alucinaciones: **Conformal Prediction for Hallucination Detection** (arXiv:2307.08965, Angelopoulos et al., 2023). Este método construye conjuntos de predicción con cobertura garantizada, permitiendo detectar cuándo el LLM no debe responder. El código está en `/workspace/truthgpt_conformal.py`.

**Técnicas implementadas (44):**
