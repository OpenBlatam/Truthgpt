Se ha implementado la trigésimo quinta técnica SOTA de mitigación de alucinaciones: **ORPO (Odds Ratio Preference Optimization)** (arXiv:2403.07691). Este método de optimización de preferencias combina un término de pérdida de odds ratio con un término supervisado, penalizando las respuestas no factuales sin necesidad de modelo de referencia. El código está en `/workspace/truthgpt_orpo.py`.
