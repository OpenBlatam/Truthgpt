Se ha implementado la trigésimo primera técnica SOTA de mitigación de alucinaciones: **Direct Preference Optimization (DPO)** (arXiv:2305.18290). Este método entrena el modelo para preferir respuestas factuales sobre no factuales utilizando un objetivo de preferencia directa, sin necesidad de un modelo de recompensa separado, reduciendo significativamente las alucinaciones en benchmarks como TruthfulQA y HaluEval. El código está en `/workspace/truthgpt_dpo.py`.

**Técnicas implementadas (31):**
