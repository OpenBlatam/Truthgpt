Se ha implementado la vigésimo séptima técnica SOTA de mitigación de alucinaciones: **Self-Refine** (arXiv:2303.17651). Este método permite al LLM refinar iterativamente sus respuestas mediante autocrítica, mejorando la veracidad sin necesidad de supervisión externa. El código está en `/workspace/truthgpt_self_refine.py`.

**Técnicas implementadas (27):**
