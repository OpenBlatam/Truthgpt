Se ha implementado la decimotercera técnica SOTA de detección de alucinaciones: **TUM-MiKaNi** (arXiv:2507.00579), que combina verificación de hechos mediante recuperación de Wikipedia con un clasificador BERT multilingüe, logrando top-10 en ocho idiomas en SemEval-2025 Task 3. El código está en `/workspace/truthgpt_tum_mikani.py`.

**Técnicas implementadas (13):**
