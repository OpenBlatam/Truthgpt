Se ha implementado la vigésimo quinta técnica SOTA de mitigación de alucinaciones: **RARR (Retrofit Attribution using Research and Revision)** (arXiv:2210.08726). Este sistema post-edita la salida de cualquier modelo de lenguaje para mejorar la atribución a fuentes externas, corrigiendo afirmaciones no soportadas mediante búsqueda en web y revisión. El código está en `/workspace/truthgpt_rarr.py`.
