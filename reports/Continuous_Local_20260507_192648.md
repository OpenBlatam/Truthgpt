Se ha implementado la trigésimo cuarta técnica SOTA de mitigación de alucinaciones: **KTO (Kahneman-Tversky Optimization)** (arXiv:2402.01306). Este método utiliza una señal binaria de preferencia (buena/mala) y una función de valor inspirada en Kahneman-Tversky para optimizar el modelo, penalizando salidas no factuales y reduciendo alucinaciones. El código está en `/workspace/truthgpt_kto.py`.
...
34. KTO (Kahneman-Tversky Optimization) (arXiv:2402.01306) – `/workspace/truthgpt_kto.py`
