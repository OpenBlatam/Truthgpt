Se ha implementado la cuadragésimo tercera técnica SOTA de mitigación de alucinaciones: **Chain-of-Abstention** (arXiv:2406.06781, Hong et al., 2024). Este método permite que el LLM evalúe su incertidumbre y se abstenga de responder cuando la incertidumbre supera un umbral, mejorando la precisión fáctica al evitar respuestas incorrectas. El código está en `/workspace/truthgpt_chain_of_abstention.py`.

**Técnicas implementadas (43):**
...
42. FLARE (arXiv:2305.06983) – `/workspace/truthgpt_flare.py`
43. Chain-of-Abstention (arXiv:2406.06781) – `/workspace/truthgpt_chain_of_abstention.py`
