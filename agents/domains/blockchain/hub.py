...
class BlockchainHub:
    ...
    @property
    def w3(self):
        return self.provider.get_web3()

    def check_eth_balance(self, address: str) -> Dict[str, Any]:
        """Check native ETH balance of an address."""
        w3 = self.w3  # Access self.w3 to trigger lazy connection if not done
        ...
        try:
            ...
            return {"address": address, "balance": "0.0", "symbol": "ETH", "error": str(e), "status": "Failed"}
