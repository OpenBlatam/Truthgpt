...
# from optimization_core.agents.framework.registry import get_tool (Lazy loaded in __init__)
...
class CodeInterpreterConfig(BaseModel):
    ...
    tools: List[str] = Field(
        default=["python_execute", "file_write", "file_read", "directory_list"],
...
class CodeInterpreterAgent(BaseAgent):
    ...
    def __init__(
        ...
        for tool_name in self.interpreter_config.tools:
            from optimization_core.agents.framework.registry import get_tool
