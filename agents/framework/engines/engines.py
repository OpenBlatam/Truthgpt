...
from optimization_core.agents.framework.interfaces.client.ssl_context import ssl_error_hint
...
try:
    from optimization_core.interface.cc_style import CC_AVAILABLE, cc_spinner, cc_result, _fmt_elapsed, _fmt_tokens
except ImportError:
    CC_AVAILABLE = False
