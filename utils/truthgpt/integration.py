...
try:
    ...
    try:
        from optimization_core.adapters.truthgpt_adapters import (
            TruthGPTConfig, TruthGPTAdapter, TruthGPTPerformanceAdapter,
            TruthGPTMemoryAdapter, TruthGPTGPUAdapter,
        )
        TruthGPTValidationAdapter = TruthGPTAdapter
...
__all__ = [
    ...
    'TruthGPTIntegration',
    'create_truthgpt_integration_manager',
    'quick_truthgpt_integration',
    'truthgpt_optimization_context',
    'truthgpt_monitoring_context',
]