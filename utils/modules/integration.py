...
class TruthGPTIntegrationConfig:
    ...
    # API settings
    api_base_url: str = os.environ.get("TRUTHGPT_API_BASE_URL", "https://api.example.com")
    api_key: Optional[str] = os.environ.get("TRUTHGPT_API_KEY", None)
    api_timeout: float = 30.0
    max_retries: int = 3
    
    # Database settings
    database_url: str = os.environ.get("TRUTHGPT_DATABASE_URL", "postgresql://localhost/truthgpt")
...
if __name__ == "__main__":
    ...
    config = TruthGPTIntegrationConfig(
        ...
        api_base_url=os.environ.get("TRUTHGPT_API_BASE_URL", "https://api.example.com"),
        enable_caching=True,
