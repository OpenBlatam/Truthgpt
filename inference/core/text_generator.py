...
class TextGenerator:
    ...
    def generate(
        ...
        **generation_kwargs
        ...
        # Generate
        raw_result = self.engine.generate(prompt, **generation_kwargs)
        result = raw_result.text if hasattr(raw_result, "text") else raw_result
    ...
    def generate_batch(
        ...
        **generation_kwargs
        ...
        if uncached_prompts:
            raw_generated = self.engine.generate(uncached_prompts, **generation_kwargs)
            if not isinstance(raw_generated, list):
                raw_generated = [raw_generated]
            
            generated = [res.text if hasattr(res, "text") else res for res in raw_generated]
