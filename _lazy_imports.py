...
_TRUTHGPT_CLOUD_LAZY_IMPORTS: Dict[str, str] = {
    ...
    'CircuitBreaker': '.truthgpt_cloud',
    'CircuitBreakerOpen': '.truthgpt_cloud',
    'CircuitState': '.truthgpt_cloud',
    'retry_with_backoff': '.truthgpt_cloud',
    'RetryConfig': '.truthgpt_cloud',
    'AlertRule': '.truthgpt_cloud',
    'AuditLogEntry': '.truthgpt_cloud',
    'BaseProofCache': '.truthgpt_cloud',
    'CachedProofEntry': '.truthgpt_cloud',
    'PaymentGatewayService': '.truthgpt_cloud',
    'AtomicJsonStorage': '.truthgpt_cloud',
    'SlidingWindowRateLimiter': '.truthgpt_cloud',
    'TokenBucketRateLimiter': '.truthgpt_cloud',
    'RateLimitExceeded': '.truthgpt_cloud',
    'RateLimitExceededError': '.truthgpt_cloud',
    'ConcurrencyLimitExceededError': '.truthgpt_cloud',
    'FormalVerificationError': '.truthgpt_cloud',
    'VerificationError': '.truthgpt_cloud',
    'BatchVerificationError': '.truthgpt_cloud',
    'InvalidTierError': '.truthgpt_cloud',
    'ModelUnavailableError': '.truthgpt_cloud',
    'PaymentError': '.truthgpt_cloud',
    'PaymentRequiredError': '.truthgpt_cloud',
    'CloudFeature': '.truthgpt_cloud',
    'VerificationEngineType': '.truthgpt_cloud',
    'ProofStatus': '.truthgpt_cloud',
    'SwarmTopologyType': '.truthgpt_cloud',
    'PaymentMethodType': '.truthgpt_cloud',
    'AlertComparisonOp': '.truthgpt_cloud',
    'CloudModuleInfo': '.truthgpt_cloud',
    'CloudPlatformStatus': '.truthgpt_cloud',
    'RedisProofCacheBackend': '.truthgpt_cloud',
    'RedisSlidingWindowRateLimiter': '.truthgpt_cloud',
    'RedisTokenBucketRateLimiter': '.truthgpt_cloud',
    'SqliteStorageBackend': '.truthgpt_cloud',
    'get_cloud_logger': '.truthgpt_cloud',
    'configure_structured_logging': '.truthgpt_cloud',
    'render_certificate_panel': '.truthgpt_cloud',
    'render_cluster_status_table': '.truthgpt_cloud',
    'render_tier_comparison_table': '.truthgpt_cloud',
    'print_certificate': '.truthgpt_cloud',
    'print_cluster_status': '.truthgpt_cloud',
    'generate_lean4_theorem': '.truthgpt_cloud',
    'generate_coq_theorem': '.truthgpt_cloud',
    'get_system_metrics': '.truthgpt_cloud',
    'create_session_jwt': '.truthgpt_cloud',
    'verify_session_jwt': '.truthgpt_cloud',
    'build_swarm_topology_graph': '.truthgpt_cloud',
    'get_topology_metrics': '.truthgpt_cloud',
    'Z3TheoremSolver': '.truthgpt_cloud',
    'z3_solver_engine': '.truthgpt_cloud',
}
