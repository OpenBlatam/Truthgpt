...
# Models subsystem lazy imports
_MODELS_LAZY_IMPORTS: Dict[str, str] = {
    'ModelManager': '.models',
    'ModelBuilder': '.models',
    'create_model_builder': '.models',
    'PositionalEncoding': '.models',
    'RotaryPositionalEmbedding': '.models',
    'ALiBiPositionalEmbedding': '.models',
    'EfficientAttention': '.models',
    'AttentionOptimizer': '.models',
    'AttentionUtils': '.models',
    'DiffusionModelManager': '.models',
    'DiffusionManager': '.models',
    'DiffusionTrainer': '.models',
    'HFTransformersModel': '.models',
    'HFLLM': '.models',
    'create_hf_transformers_model': '.models',
    'HFDiffusersModel': '.models',
    'HFDiffusion': '.models',
    'create_hf_diffusers_model': '.models',
    ...
    'build_model': '.models',
    'ModelError': '.models',
    'ModelNotFoundError': '.models',
    'ModelInitializationError': '.models',
    'ModelLoadError': '.models',
    'ModelSaveError': '.models',
    'ModelInferenceError': '.models',
    'ModelConfigurationError': '.models',
    'ModelOptimizationError': '.models',
    'DevicePlacementError': '.models',
    'QuantizationError': '.models',
    'AttentionError': '.models',
    'DiffusionError': '.models',
    'BaseModel': '.models',
    'BaseModelManager': '.models',
    'BaseDiffusionManager': '.models',
    'BaseAttentionOptimizer': '.models',
    'IModel': '.models',
    'IModelManager': '.models',
    'IDiffusionManager': '.models',
    'IAttentionOptimizer': '.models',
    'ModelInfoResult': '.models',
    'ModelLoadResult': '.models',
    'ModelSaveResult': '.models',
    'ModelInferenceResult': '.models',
    'GenerationConfig': '.models',
    'DiffusionInferenceResult': '.models',
    'AttentionOptimizationResult': '.models',
}
