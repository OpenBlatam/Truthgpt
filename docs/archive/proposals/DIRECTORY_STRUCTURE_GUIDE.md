...
- [PHASE2_DIRECTORY_REORGANIZATION.md](../refactoring_history/PHASE2_DIRECTORY_REORGANIZATION.md) - Plan de reorganización
- [ARCHITECTURE_IMPROVEMENTS.md](../refactoring_history/ARCHITECTURE_IMPROVEMENTS.md) - Mejoras arquitectónicas
