...
try:
    from truthgpt.agents.observability import global_tracer
except ImportError:
...
class MultiUserReActAgent:
    ...
    def _get_system_instructions(self) -> str:
        ...
        from truthgpt.agents.prompts.prompt_manager import prompt_manager
    ...
    async def _finalize_completion(self, user_id: str, message: str, final_answer: str, task_id: str, trace_id: str) -> AgentResponse:
        ...
        if self.persistent:
            from truthgpt.modules.persistence.task_manager import get_persistence_manager
    ...
    async def _execute_tool_action(self, trace_id: str, action: AgentAction, user_id: str) -> str:
        ...
        try:
            ...
            from truthgpt.agents.exceptions import ToolExecutionError
    ...
    async def _run_react_loop(self, user_id: str, message: str, task_id: str) -> 'AsyncIterator[Dict[str, Any]]':
        ...
        from truthgpt.agents.engine_providers import DummyAsyncLLM
    ...
    async def _checkpoint(self, task_id: str, user_id: str, original_msg: str, prompt: str, iteration: int):
        ...
        from truthgpt.modules.persistence.task_manager import get_persistence_manager, TaskSnapshot
