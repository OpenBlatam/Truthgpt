...
if _papers_source.exists():
    try:
        ...
        try:
            ...
            try:
                from truthgpt.modules.base.core_system.core.metadata_extractor import MetadataExtractor, PaperMetadata as SourcePaperMetadata
                from truthgpt.modules.base.core_system.core.paper_registry_refactored import PaperRegistryRefactored, PaperModule as SourcePaperModule
                _PAPERS_AVAILABLE = True
