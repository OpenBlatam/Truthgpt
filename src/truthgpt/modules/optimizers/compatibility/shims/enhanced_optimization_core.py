...
class EnhancedOptimizationCore:
    ...
    Migration:
        # Old code
        from truthgpt.optimizers.enhanced_optimization_core import EnhancedOptimizationCore
        optimizer = EnhancedOptimizationCore(config)
        
        # New code
        from truthgpt.optimizers.core.unified_optimizer import UnifiedOptimizer
        from truthgpt.optimizers.core.base_truthgpt_optimizer import OptimizationLevel
