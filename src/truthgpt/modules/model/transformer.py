...
class TransformerModel(nn.Module):
    ...
    def __init__(self, config: TransformerConfig):
        ...
        # Embeddings
        self.embeddings = nn.Embedding(config.vocab_size, truthgpt.config.hidden_size)
        self.position_embeddings = nn.Embedding(config.max_position_embeddings, truthgpt.config.hidden_size)
