...
class TruthGPTModel(nn.Module):
    ...
    def __init__(self, config: TruthGPTModelConfig):
        ...
        # Embeddings
        self.token_embeddings = nn.Embedding(config.vocab_size, truthgpt.config.hidden_size)
        ...
        self.lm_head = nn.Linear(config.hidden_size, truthgpt.config.vocab_size, bias=False)
