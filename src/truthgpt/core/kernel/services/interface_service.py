    ...
    async def execute_command(self, choice: str, user_input: str) -> bool:
        ...
        if choice in self.COMMAND_MAP:
            ...
            if choice and not choice.isspace():
                from truthgpt.interface.comm_menu import handle_executive_prompt
                try:
